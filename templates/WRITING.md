...
- When a turn creates a markdown file outside memory that no note names, you are told at the next prompt. A document a later session should find needs one line in the note for that work: the path and what it holds.
